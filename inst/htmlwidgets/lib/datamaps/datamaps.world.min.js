! function() {
    ...
    function b(a, b) {
        ...
        return b && "undefined" == typeof b.scope && (b.scope = "world"), "usa" === b.scope ? c = l.geo.albersUsa().scale(e).translate([e / 2, f / 2]) : "world" === b.scope && (c = l.geo[b.projection]().scale((e + 1) / 2 / Math.PI).translate([e / 2, f / ("mercator" === b.projection ? 1.45 : 1.8)])), d = l.geo.path().projection(c), {
            path: d,
            projection: c
        }
    }
    ...
    function f(a, b) {
        if (b = b || {}, this.options.fills) {
            ...
            c += "</dl>", l.select(this.options.element).append("div").attr("class", "datamaps-legend").html(c)
        }
    }
    ...
    k.prototype.draw = function() {
        ...
        for (var c in a)
            if (a.hasOwnProperty(c)) {
                var d, e = a[c];
                if (!c) continue;
                d = "string" == typeof e ? e : "string" == typeof e.color ? e.color : this.options.fills[e.fillKey], e === Object(e) && (this.options.data[c] = j(e, this.options.data[c] || {}), this.svg.select("." + c).attr("data-info", JSON.stringify(this.options.data[c]))), b.selectAll("." + c).transition().style("fill", d)
            }
